...
gen "lunka-portrait"   "Cinematic character key art of a frail pale young medieval peasant woman wrapped in a worn woolen shawl, fevered but quietly resolute, sitting by faint candlelight in a humble dark cottage, soft warm glow against cold shadow, fragile and sympathetic mood, an original character not based on any existing game."
gen "esme-portrait"    "Cinematic character key art of a careworn kind-eyed older medieval peasant woman in a simple headscarf, weathered hands, lit by the warm orange glow of a hearth fire in a dim rustic cottage, tender and weary, an original character not based on any existing game."
